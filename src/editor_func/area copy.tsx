...
const WorkspaceDivider: React.FC = () => {
  ...
  let mode:("drag"|"split") = "split"; // 현재 분할 중인지 여부
  ...
  const handleMouseMove = (e: MouseEvent) => {
    if (mode === "split" && (!resizeTarget || !dragStart || !containerRef.current)) return;
  ...
  const handleEdgeHover = (
    ...
    e.currentTarget.style.cursor = e.ctrlKey ? cursor.split[direction] : cursor.drag[direction];
  };
