...
const Area = ({ id, x, y, width, height, isSelected, isMinimize, children }:IArea) => {
  ...
  return (
    ...
    >
      {/* 4방향 컨트롤러 */}
      <div data-type={'areaEdge'} className="edge top"   style={{height:Thickness}}></div>
      <div data-type={'areaEdge'} className="edge right" style={{width:Thickness}}></div>
      <div data-type={'areaEdge'} className="edge bottom"style={{height:Thickness}}></div>
      <div data-type={'areaEdge'} className="edge left"  style={{width:Thickness}}></div>
