...
| 21:41 ~ 23:53 | 하이라이트 작동시 뒷 배경이 보여서, 하얀색으로 변경하게만 설정<br>받은 방향의 반대 방향을 반환하는 함수 unit.ts에 추가<br>삽질 한 뒤에, 마침내!!!<br>드디어 인접한 경계가 같이 움직이는 UI 구현 완료 | 완료 | 003-3, <span title="Vercel 호스팅 중">*003-4\**</span><br> |
